...
var availability = function availability() {
  ...
  var requiredFieldIds = ['billing_postcode', 'billing_country'];
  var mustHaveCountry = 'SE';
  /**
   * Disable Freight
   */
...
/***/ "./assets/js/freight-service-point/findPlace.js":
/*!******************************************************!*\
  !*** ./assets/js/freight-service-point/findPlace.js ***!
  \******************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (findPlace);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _availability__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./availability */ "./assets/js/freight-service-point/availability.js");
/* harmony import */ var _findPlace__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./findPlace */ "./assets/js/freight-service-point/findPlace.js");
...
var fsp = function fsp() {
  ...
  var init = function init() {
    ...
    Object(_availability__WEBPACK_IMPORTED_MODULE_0__["default"])().init();
    document.querySelector('#dhl-fr-find') && Object(_findPlace__WEBPACK_IMPORTED_MODULE_1__["default"])().init();
  };
...
var locationSelector = function locationSelector() {
  ...
  var noResultsNotice = document.querySelector('.dhl-freight-cf__field-wrap__noresults'); // Billing fields

  var postalCodeField = document.getElementById('billing_postcode');
  var city = document.getElementById('billing_city');
  var address = document.getElementById('billing_address_1');
  var data = []; // @todo Implement cache
