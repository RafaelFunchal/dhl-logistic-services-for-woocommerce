...
/* harmony import */ var _freight_service_point_fsp__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./freight-service-point/fsp */ "./assets/js/freight-service-point/fsp.js");
// Deps
...
var actions = function actions() {
  var run = function run() {
    Object(_freight_service_point_fsp__WEBPACK_IMPORTED_MODULE_0__["default"])().init();
  };
...
/***/ "./assets/js/freight-service-point/availability.js":
/*!*********************************************************!*\
  !*** ./assets/js/freight-service-point/availability.js ***!
  \*********************************************************/
...
var availability = function availability() {
  var fields = document.querySelector('.dhl-freight-cf');
  var requiredFieldIds = ['billing_postcode', 'billing_country']; // @todo move to the setting parameter

  var mustHaveCountry = dhl.shopCountry.country;
  /**
   * Disable Freight
   */
  ...
  var check = function check() {
    ...
    requiredFieldIds.forEach(function (fieldId) {
      var field = document.getElementById(fieldId); // If no value set atleast in one of the fields disable flow
      ...
      if (fieldId === 'billing_country' && field.value !== mustHaveCountry) {
        available = false;
      }
    });
  ...
  var init = function init() {
    check();
    requiredFieldIds.forEach(function (fieldId) {
      var field = document.getElementById(fieldId); // Has to be jQuery due to select2 which would require enableNativeEvent
...
/* harmony default export */ __webpack_exports__["default"] = (availability);

/***/ }),

/***/ "./assets/js/freight-service-point/billingData.js":
/*!********************************************************!*\
  !*** ./assets/js/freight-service-point/billingData.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var billingData = function billingData() {
  ...
  var getCountryTitle = function getCountryTitle() {
    return billing_country.querySelector('[value="' + getCountryField().value + '"]').innerHTML;
  };

  var getCountryField = function getCountryField() {
    return billing_country;
  };

  var getPostCodeField = function getPostCodeField() {
    return billing_postcode;
  };

  var getCityField = function getCityField() {
    return billing_city;
  };

  var getAddressOneField = function getAddressOneField() {
    return billing_address_1;
  };

  return {
    getPostCodeField: getPostCodeField,
    getCityField: getCityField,
    getAddressOneField: getAddressOneField,
    getCountryField: getCountryField,
    getCountryTitle: getCountryTitle
  };
};

/* harmony default export */ __webpack_exports__["default"] = (billingData);

/***/ }),

/***/ "./assets/js/freight-service-point/fsp.js":
/*!************************************************!*\
  !*** ./assets/js/freight-service-point/fsp.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mapFinder__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mapFinder */ "./assets/js/freight-service-point/mapFinder.js");
/* harmony import */ var _availability__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./availability */ "./assets/js/freight-service-point/availability.js");
/* harmony import */ var _locationSelector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./locationSelector */ "./assets/js/freight-service-point/locationSelector.js");
/* harmony import */ var _billingData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./billingData */ "./assets/js/freight-service-point/billingData.js");





var fsp = function fsp() {
  /**
   * Initialize functionality
   */
  var init = function init() {
    ...
    window.billingData = Object(_billingData__WEBPACK_IMPORTED_MODULE_3__["default"])();
    window.locationSelector = Object(_locationSelector__WEBPACK_IMPORTED_MODULE_2__["default"])();
    window.mapFinder = Object(_mapFinder__WEBPACK_IMPORTED_MODULE_0__["default"])();
    Object(_availability__WEBPACK_IMPORTED_MODULE_1__["default"])().init();
  };
...
/* harmony default export */ __webpack_exports__["default"] = (fsp);

/***/ }),

/***/ "./assets/js/freight-service-point/locationSelector.js":
/*!*************************************************************!*\
  !*** ./assets/js/freight-service-point/locationSelector.js ***!
  \*************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_locationService__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services/locationService */ "./assets/js/freight-service-point/services/locationService.js");
/* harmony import */ var _shipData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shipData */ "./assets/js/freight-service-point/shipData.js");



var locationSelector = function locationSelector() {
  var field = document.getElementById('dhl_freight_selected_service_point');
  var noResultsNotice = document.querySelector('.dhl-freight-cf__field-wrap__noresults');
  var data = []; // @todo Implement cache in future

  var cached = [];

  var clearOptions = function clearOptions() {
    // Clear options
    field.innerHTML = ''; // Add select point option
  ...
  var setOptions = function setOptions(points) {
    clearOptions();
    data = []; // Add new
  ...
  var getPoint = function getPoint(id) {
    return data[id];
  };
...
/***/ "./assets/js/freight-service-point/mapFinder.js":
/*!******************************************************!*\
  !*** ./assets/js/freight-service-point/mapFinder.js ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _shipData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shipData */ "./assets/js/freight-service-point/shipData.js");
/* harmony import */ var _services_locationService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/locationService */ "./assets/js/freight-service-point/services/locationService.js");



var mapFinder = function mapFinder() {
  ...
  var addMarker = function addMarker(point) {
    ...
    marker.addListener('click', function () {
      var point = marker.get('point'); // Update shipping address

      Object(_shipData__WEBPACK_IMPORTED_MODULE_0__["default"])().setData(point); // Make dropdown valu to be same
  ...
  var updateMap = function updateMap() {
    _services_locationService__WEBPACK_IMPORTED_MODULE_1__["default"].request({
      ...
      if (response.data.length > 0) {
        addPoints(response.data); // Set dropdown values
...
/* harmony default export */ __webpack_exports__["default"] = (mapFinder);

/***/ }),

/***/ "./assets/js/freight-service-point/services/locationService.js":
/*!*********************************************************************!*\
  !*** ./assets/js/freight-service-point/services/locationService.js ***!
  \*********************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (new LocationService());

/***/ }),

/***/ "./assets/js/freight-service-point/shipData.js":
/*!*****************************************************!*\
  !*** ./assets/js/freight-service-point/shipData.js ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var shipData = function shipData() {
...
/* harmony default export */ __webpack_exports__["default"] = (shipData);
